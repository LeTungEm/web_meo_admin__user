  ...
  export default {
    ...
    watch:{
      serviceData: function(){
        this.description = this.serviceData;
      }
    },
    props:{
      serviceData: String,
    ...
    methods:{
      ...
      saveData(){
          SettingService.updateService(this.description).then(res => {
            console.log(res.data);
            this.showNotification(["Sửa thành công dịch vụ spa và hotel", false]);
          })
      },
    },
  };
